var salt = context.getVariable("_headers_salt");
...
context.setVariable("request.header.X-SID",host);
context.setVariable("request.header.X-TS", now);
context.setVariable("request.header.X-TOKEN", base64_token);